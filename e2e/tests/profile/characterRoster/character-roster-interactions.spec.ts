...
test.describe('Character Roster on Profile', () => {
    ...
    test.skip('character cards display character name', async ({ page }) => {
        // TODO: Locate first character card
        // TODO: Verify character name is visible
    })

    test.skip('character cards display character class', async ({ page }) => {
        // TODO: Locate first character card
        // TODO: Verify character class is displayed
    })

    test.skip('character cards display character race', async ({ page }) => {
        // TODO: Locate first character card
        // TODO: Verify character race is displayed
    })

    test.skip('character cards display character level', async ({ page }) => {
        // TODO: Locate first character card
        // TODO: Verify character level is displayed
    })

    test.skip('character cards show character avatar/image', async ({ page }) => {
        // TODO: Locate first character card
    ...
    test.skip('clicking last page shows final characters', async ({ page }) => {
        // TODO: Click last page button
        // TODO: Verify navigated to last page
        // TODO: Verify correct characters are shown
    })

    test.skip('clicking first page returns to beginning', async ({ page }) => {
        // TODO: Navigate to page 2 or later
        // TODO: Click first page button
        // TODO: Verify back on first page
    })

    test.skip('next/previous buttons are disabled appropriately', async ({ page }) => {
    ...
    test.skip('roster displays characters in correct order', async ({ page }) => {
        // TODO: Verify characters are sorted correctly
        // TODO: Verify most recent/alphabetical order
    })

    test.skip('roster shows create character button in top right corner', async ({ page }) => {
        // TODO: Navigate to profile
        // TODO: Verify create character button in top right roster area
    })

    test.skip('empty state shows centered create character button', async ({ page }) => {
