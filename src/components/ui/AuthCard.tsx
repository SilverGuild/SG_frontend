...
export default function AuthCard({ title, children }: {title: string, children: ReactNode }) {
    return (
       <div className="fixed inset-0 w-full h-screen overflow-hidden bg-midnight">
            <StarField />
            ...
            <div className="relative z-10 h-full w-full overflow-y-auto flex items-center justify-center px-4 py-12">
